...
public class TopoEditTest : BaseTest
{
    ...
    {
        // Reproduces https://github.com/Septima/NetTopologySuite.Topo/issues/2

        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(0 10)"));
        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(0 0)"));
        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(1 2)"));
        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(1 8)"));
        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(2 1)"));
        Topology = TopologyEditor.AddIsoNode(Topology, Face.Universe, Read<Point>("POINT(2 9)"));
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[0], Topology.Nodes[1], Read<LineString>("LINESTRING (0 10, 10 10, 10 0, 0 0)"));
        Assert.AreEqual("1 -1 1 0 0", Topology.EdgeRels[1].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[0], Topology.Nodes[1], Read<LineString>("LINESTRING (0 10, 0 0)"));
        Assert.AreEqual("1 -2 2 0 1", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 1 1 0", Topology.EdgeRels[2].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[1], Topology.Nodes[0], Read<LineString>("LINESTRING (0 0, -10 0, -10 10, 0 10)"));
        Assert.AreEqual("1 3 2 0 1", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 1 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[2], Topology.Nodes[4], Read<LineString>("LINESTRING (1 2, 2 2, 2 1)"));
        Assert.AreEqual("1 3 2 0 1", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 1 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Assert.AreEqual("4 -4 4 1 1", Topology.EdgeRels[4].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[3], Topology.Nodes[2], Read<LineString>("LINESTRING (1 8, 1 2)"));
        Assert.AreEqual("1 3 2 0 1", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 1 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Assert.AreEqual("4 -4 -5 1 1", Topology.EdgeRels[4].ToString());
        Assert.AreEqual("5 4 5 1 1", Topology.EdgeRels[5].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[4], Topology.Nodes[2], Read<LineString>("LINESTRING (2 1, 1 1, 1 2)"));
        Assert.AreEqual("1 3 2 0 4", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 4 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Assert.AreEqual("4 6 -6 4 3", Topology.EdgeRels[4].ToString());
        Assert.AreEqual("5 4 5 4 4", Topology.EdgeRels[5].ToString());
        Assert.AreEqual("6 -5 -4 4 3", Topology.EdgeRels[6].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[5], Topology.Nodes[3], Read<LineString>("LINESTRING (2 9, 2 8, 1 8)"));
        Assert.AreEqual("1 3 2 0 4", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 4 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Assert.AreEqual("4 6 -6 4 3", Topology.EdgeRels[4].ToString());
        Assert.AreEqual("5 4 -7 4 4", Topology.EdgeRels[5].ToString());
        Assert.AreEqual("6 -5 -4 4 3", Topology.EdgeRels[6].ToString());
        Assert.AreEqual("7 5 7 4 4", Topology.EdgeRels[7].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[3], Topology.Nodes[5], Read<LineString>("LINESTRING (1 8, 1 9, 2 9)"));
        Assert.AreEqual("1 3 2 0 6", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 6 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        Assert.AreEqual("4 6 -6 6 3", Topology.EdgeRels[4].ToString());
        Assert.AreEqual("5 4 8 6 6", Topology.EdgeRels[5].ToString());
        Assert.AreEqual("6 -5 -4 6 3", Topology.EdgeRels[6].ToString());
        Assert.AreEqual("7 5 -8 6 5", Topology.EdgeRels[7].ToString());
        Assert.AreEqual("8 7 -7 6 5", Topology.EdgeRels[8].ToString());
        Topology = TopologyEditor.AddEdgeNewFaces(Topology, Topology.Nodes[4], Topology.Nodes[5], Read<LineString>("LINESTRING (2 1, 9 1, 9 9, 2 9)"));
        Assert.AreEqual("1 3 2 0 7", Topology.EdgeRels[1].ToString());
        Assert.AreEqual("2 -1 -3 7 2", Topology.EdgeRels[2].ToString());
        Assert.AreEqual("3 1 -2 0 2", Topology.EdgeRels[3].ToString());
        // TODO: figure out why actual is 4 9 -6 7 3
        Assert.AreEqual("4 9 -6 8 3", Topology.EdgeRels[4].ToString());
        Assert.AreEqual("5 4 8 8 7", Topology.EdgeRels[5].ToString());
        Assert.AreEqual("6 -5 -4 7 3", Topology.EdgeRels[6].ToString());
        Assert.AreEqual("7 5 -8 8 5", Topology.EdgeRels[7].ToString());
        Assert.AreEqual("8 -9 -7 7 5", Topology.EdgeRels[8].ToString());
        Assert.AreEqual("9 7 6 8 7", Topology.EdgeRels[9].ToString());
        var polys = Topology.Faces.Select(f => TopologyEditor.GetFaceGeometry(Topology, f));
        Assert.IsTrue(polys.All(p => p is Polygon), "Not all faces are polygons");
        Assert.IsTrue(polys.All(p => p.IsValid), "Not all face polygons are valid");
    }
}